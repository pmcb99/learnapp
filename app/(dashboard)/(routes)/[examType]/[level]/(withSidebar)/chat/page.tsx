    ...
    <div>
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-x-2 gap-y-2 px-20 lg:px-32 ">
        {lcHigherSubjects.map((subject) => (
          <Card onClick={() => router.push(`${hrefPrefix}/chat/${subject.href}/`)} key={subject.href} className="p-5 border-slate-700 flex items-center justify-between hover:shadow-md hover:scale-105 transition cursor-pointer">
